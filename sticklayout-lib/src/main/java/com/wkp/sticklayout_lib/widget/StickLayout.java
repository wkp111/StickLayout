package com.wkp.sticklayout_lib.widget;
...
public class StickLayout extends FrameLayout implements NestedScrollingParent,
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<StickLayout.SavedState> CREATOR =
                new Parcelable.Creator<StickLayout.SavedState>() {
                    @Override
